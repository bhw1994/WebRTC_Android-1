...
import com.webrtc.boyj.api.peer.manager.DefaultPeerConnectionFactory;
...
public class PeerConnectionClient {
    ...
    public void init() {
        initIceServers();
        peerConnectionFactory = new DefaultPeerConnectionFactory(App.getContext(), EglBaseManager.getEglBase()).createPeerConnectionFactory();
        createVideoTrack();
        createAudioTrack();
